...
export const businessCategories = [
  { value: "", label: "Please Select Business Category" },
  { value: 1, label: "Pharmacy / Grocery store" },
  { value: 2, label: "Electrical store" },
  { value: 3, label: "E-commerce Apparel store" },
  { value: 4, label: "Antique shop" },
  { value: 5, label: "Art supply store" },
  { value: 6, label: "Bakery store" },
  { value: 7, label: "Beauty & body care products store" },
  { value: 8, label: "Bookstore" },
  { value: 9, label: "Butcher store" },
  { value: 10, label: "Candy store" },
  { value: 11, label: "Car accessories" },
  { value: 12, label: "Car store" },
  { value: 13, label: "Cleaning supplies store" },
  { value: 14, label: "Clothes shop" },
  { value: 15, label: "Coffee shop" },
  { value: 16, label: "Convenience store" },
  { value: 17, label: "Cosmetics & make up store" },
  { value: 18, label: "Department store" },
  { value: 19, label: "Disabled accessories store" },
  { value: 20, label: "Discount store" },
  { value: 21, label: "E-commerce store" },
  { value: 22, label: "Electrical Industrial store" },
  { value: 23, label: "Electronics Store" },
  { value: 24, label: "Fishing shop" },
  { value: 25, label: "Florist" },
  { value: 26, label: "Furniture store" },
  { value: 27, label: "Gaming Store" },
  { value: 28, label: "Garden store" },
  { value: 29, label: "Gift shop" },
  { value: 30, label: "Greengrocer" },
  { value: 31, label: "Grocery store" },
  { value: 32, label: "Handbags store" },
  { value: 33, label: "Hardware store" },
  { value: 34, label: "Herbal store" },
  { value: 35, label: "Home appliances & household goods store" },
  { value: 36, label: "Home decor store" },
  { value: 37, label: "Hunting shop" },
  { value: 38, label: "Hypermarket" },
  { value: 39, label: "Jewelry store" },
  { value: 40, label: "Kiosk" },
  { value: 41, label: "Music shop" },
  { value: 42, label: "Organic food store" },
  { value: 43, label: "Pet store" },
  { value: 44, label: "Pharmacy / Drug store" },
  { value: 45, label: "Regional foods store" },
  { value: 46, label: "Retail outlet" },
  { value: 47, label: "Scented candles, soap and perfume shop" },
  { value: 48, label: "Sculptures, paintings and art store" },
  { value: 49, label: "Shoe store" },
  { value: 50, label: "Skate shop" },
  { value: 51, label: "Souvenir shop" },
  { value: 52, label: "Stall" },
  { value: 53, label: "Stationery shop" },
  { value: 54, label: "Supermarket" },
  { value: 55, label: "Thrift store" },
  { value: 56, label: "Tobacco shop" },
  { value: 57, label: "Toy store" },
  { value: 58, label: "Vape shop" },
  { value: 59, label: "Warehouse store" },
  { value: 60, label: "Mobile and Telecom Shop" },
];
